...
import { Button } from "../component/ui/button"; // Assuming you have a Button component
import Image from "next/image";
import Rectangle from "../../../public/assests/Rectangle.png"
  ...
  return (
    <div className="flex justify-between p-5 sm:p-10">
      ...
      <div className="w-1/2 flex justify-center items-center">
        <Image
          src={Rectangle} // Replace with your image URL
          alt="Product"
